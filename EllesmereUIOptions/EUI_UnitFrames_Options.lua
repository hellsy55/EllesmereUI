...
-- Shared "Strata" dropdown values for the per-zone text Strata option
...
initFrame:SetScript("OnEvent", function(self)
    ...
    -- overrides get cleared) from source to chosen unit. A key is shared unless
    ...
    -- other frames and copies to the chosen one after a confirm popup. getValue
    -- always returns the placeholder so the dropdown stores nothing; the registered
    -- widget refresh snaps the label back after each pick.
