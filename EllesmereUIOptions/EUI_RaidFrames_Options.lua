    ...
    local function BuildVisualSections(parent, y, W, onSection)
        ...
        if not EllesmereUI._prebuilding then
            ...
            local function UpdateSwatchVis()
                ...
                -- Single custom swatch: live only in Custom mode, dimmed+blocked in other modes, fully HIDDEN in Dynamic mode so it doesn't sit behind the three dynamic swatches.
                if isDynamic then
