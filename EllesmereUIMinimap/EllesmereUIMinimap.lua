...
local function FTTOpenWhisper(charName, bnetName)
    ...
    -- same secret-value environment as a real Mythic+ via addonChallengeModeRestrictionsForced,
    -- which InProtectedInstance() does NOT see -- hence the separate check).
    local blocked
